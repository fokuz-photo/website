...
class __TwigTemplate_a0087b36314238596c36c5bee9efa993548ceaba7ee355d8e55658d02dc4602e extends \Twig\Template
{
...
";
        ...
        if (($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", []), "sticky", []) || twig_trim_filter(($context["offcanvas"] ?? null)))) {
            ...
            echo (($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", [], "any", false, true), "swipe", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", [], "any", false, true), "swipe", []), "1")) : ("1"));
            echo "\" data-g-offcanvas-css3=\"";
            echo (($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", [], "any", false, true), "css3animation", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", [], "any", false, true), "css3animation", []), "1")) : ("1"));
            echo "\">
    ";
            // line 12
...
";
    ...
    {
        return new Source("", "@nucleus/layout/offcanvas.html.twig", "/mnt/web215/a2/02/510687002/htdocs/prod/public_html/app/plugins/gantry5/engines/nucleus/templates/layout/offcanvas.html.twig");
    }
}
