...
class __TwigTemplate_be92d11017bfc323547ecec578678dafa2b7911f53a1c1adb7708076ff049e9f extends \Twig\Template
{
...
";
        ...
        if (twig_trim_filter(($context["html"] ?? null))) {
            // line 17
            echo "    <div class=\"";
            echo (($context["class"] ?? null) . (($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", []), "class", [])) ? ((" " . twig_join_filter($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", []), "class", []), " "))) : ("")));
            echo "\">
        ";
            // line 18
...
";
    ...
    {
        return new Source("", "@nucleus/content/system.html.twig", "/mnt/web215/a2/02/510687002/htdocs/prod/public_html/app/plugins/gantry5/engines/nucleus/templates/content/system.html.twig");
    }
}
