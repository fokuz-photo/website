...
class __TwigTemplate_20f99154aa944b1583e1f217f22721816714b30120b80a5feb92ed662d878e3b extends \Twig\Template
{
...
";
        ...
        if (twig_trim_filter(($context["html"] ?? null))) {
            ...
            if ($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", []), "id", [])) {
                echo "id=\"";
                echo $this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", []), "id", []);
                echo "\" ";
            }
            echo "class=\"";
...
";
    ...
    {
        return new Source("", "@nucleus/layout/block.html.twig", "/mnt/web215/a2/02/510687002/htdocs/prod/public_html/app/plugins/gantry5/engines/nucleus/templates/layout/block.html.twig");
    }
}
