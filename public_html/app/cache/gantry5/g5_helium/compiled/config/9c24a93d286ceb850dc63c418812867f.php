...
return [
    ...
    'checksum' => '708bdbe3ffb4593f20478f07748fe0f1',
    'files' => [
        'app/themes/g5_helium/custom/config/home_-_backup' => [
            'index' => [
                'file' => 'app/themes/g5_helium/custom/config/home_-_backup/index.yaml',
                'modified' => 1733835533
            ],
            'layout' => [
                'file' => 'app/themes/g5_helium/custom/config/home_-_backup/layout.yaml',
                'modified' => 1733829679
            ]
        ],
    ...
    'data' => [
        ...
        'index' => [
            ...
            'particles' => [
                ...
                'messages' => [
                    'system-messages-4741' => 'System Messages'
                ],
                'logo' => [
                    'logo-2399' => 'Logo / Image',
                    'logo-4350' => 'Logo / Image'
                ],
                'menu' => [
                    'menu-2185' => 'Menu'
                ],
                ...
                'verticalmenu' => [
                    'verticalmenu-8233' => 'Vertical Menu',
                    'verticalmenu-7266' => 'Vertical Menu'
                ],
                'contact' => [
                    'contact-9659' => 'Contact'
                ],
                'totop' => [
                    'totop-4588' => 'To Top'
                ],
                'mobile-menu' => [
                    'mobile-menu-4582' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
                'default' => [
                    ...
                    'footer' => 'footer',
                    'offcanvas' => 'offcanvas',
                    'system-messages-4741' => 'system-messages-7972',
                    'logo-2399' => 'logo-9608',
                    'menu-2185' => 'menu-6409',
                    'social-8734' => 'social-3171',
                    'logo-4350' => 'logo-9571',
                    'verticalmenu-8233' => 'verticalmenu-3628',
                    'verticalmenu-7266' => 'verticalmenu-6607',
                    'contact-9659' => 'contact-6866',
                    'totop-4588' => 'totop-8670',
                    'mobile-menu-4582' => 'mobile-menu-5697'
                ]
            ]
        ],
        'layout' => [
