<div id="sunshine-install--license" class="sunshine-install--step">
	<form method="post" action="<?php echo admin_url( 'edit.php?post_type=sunshine-gallery&page=sunshine-install&step=license' ); ?>">
		...
		<p>
			<label><input type="radio" name="product" value="pro" checked /> Pro</label> &nbsp;
			<label><input type="radio" name="product" value="plus" /> Plus</label>
		</p>
		<p>
			<input type="text" name="license" value="" required />
		</p>
		<p style="color: #666; margin-top: 30px;">A paid license is not required to use Sunshine Photo Cart. You may to use this free version as long as you want!</p>
